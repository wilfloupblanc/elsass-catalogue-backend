import { Controller } from "@lyra-js/core";
export class ExampleStaticController extends Controller {
     ...
     */
    static exampleRouteMethod(req, res, next) {
        try {
            const exampleItem = {
                id: 1,
                title: "Static Controller Method Example",
                content: "This response is generated by a static controller method. Static methods are the traditional approach for defining route handlers in LyraJS, registered manually in route files. This endpoint returns JSON data, making it suitable for REST APIs consumed by frontend applications or mobile apps."
            };
