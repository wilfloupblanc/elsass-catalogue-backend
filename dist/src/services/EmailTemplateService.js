export class EmailTemplateService {
    static accountValidationMail(username, validationLink) {
        return `<!doctype html>
            <html lang="en">
            <head>
    ...
    static resetPasswordMail(username, resetPasswordLink) {
        return `<!doctype html>
            <html lang="en">
            <head>
...
EmailTemplateService.signature = `<p>The <a href="${process.env.CLIENT_APP_URL}">Moviz App</a> Team</p>`;
EmailTemplateService.mailStyles = `<style>
                body {
